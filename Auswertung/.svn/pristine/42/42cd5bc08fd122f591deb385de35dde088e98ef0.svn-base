...
echo "UDPPackets rcvd AODV: "$sumRcvdAODV
echo "UDPPackets lost AODV: "$sumLostAODV
echo -e "7.5\t"$sumLostGeneral'\t'$sumLostAODV'\t'$sumSentGeneral'\t'$sumSentAODV	 >> RcvdPkts${11}.dat;
#
#
#
####################################
...
echo "UDPPackets rcvd AODV: "$sumRcvdAODV
echo "UDPPackets lost AODV: "$sumLostAODV
echo -e "15\t"$sumLostGeneral'\t'$sumLostAODV'\t'$sumSentGeneral'\t'$sumSentAODV	 >> RcvdPkts${11}.dat;
#
#
#
####################################
...
echo "UDPPackets rcvd AODV: "$sumRcvdAODV
echo "UDPPackets lost AODV: "$sumLostAODV
echo -e "22.5\t"$sumLostGeneral'\t'$sumLostAODV'\t'$sumSentGeneral'\t'$sumSentAODV	 >> RcvdPkts${11}.dat;
#
#
#
####################################
