...
echo "Payload sent AODV: " $sumSentPayloadAODV
echo "AODVPackets sent AODV: "$sumSentAODVPktsAODV
echo -e "7.5\t"$routingLoadD2DRS'\t'$routingLoadAODV'\t'$sumSentAODVPktsGeneral'\t'$sumSentAODVPktsAODV	 >> RoutingLoad${11}.dat;
#
#
#
####################################
...
echo "Payload sent AODV: " $sumSentPayloadAODV
echo "AODVPackets sent AODV: "$sumSentAODVPktsAODV
echo -e "15\t"$routingLoadD2DRS'\t'$routingLoadAODV'\t'$sumSentAODVPktsGeneral'\t'$sumSentAODVPktsAODV	 >> RoutingLoad${11}.dat;
#
#
#
####################################
...
echo "Payload sent AODV: " $sumSentPayloadAODV
echo "AODVPackets sent AODV: "$sumSentAODVPktsAODV
echo -e "22.5\t"$routingLoadD2DRS'\t'$routingLoadAODV'\t'$sumSentAODVPktsGeneral'\t'$sumSentAODVPktsAODV	 >> RoutingLoad${11}.dat;
#
#
#
####################################
