...
set title "Relation RREQ-RREP with Sending Frequency 0.5Sec";
plot "RREQRREP05Sec.dat" using 1:2 title 'RREQTORS' with linespoints ls 1, "RREQRREP05Sec.dat" using 1:3 title 'RRESP' with linespoints ls 2;
