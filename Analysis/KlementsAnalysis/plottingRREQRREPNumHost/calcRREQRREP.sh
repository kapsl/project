...
echo "LinkBreacks General: " $sumLinkBreaksD2DRS
echo "LinkBreacksAODV: "$sumLinkBreacksAODV
echo -e "7.5\t"$sumSentRREQD2DRS'\t'$sumRceivedRREPD2DRS'\t'$sumSentRERRD2DRS'\t'$sumLinkBreaksD2DRS'\t'$sumSentRERRAODV'\t'$sumLinkBreacksAODV	 >> RREQRREP${11}.dat;
#
#
#
####################################
...
echo "LinkBreacks General: " $sumLinkBreaksD2DRS
echo "LinkBreacksAODV: "$sumLinkBreacksAODV
echo -e "15\t"$sumSentRREQD2DRS'\t'$sumRceivedRREPD2DRS'\t'$sumSentRERRD2DRS'\t'$sumLinkBreaksD2DRS'\t'$sumSentRERRAODV'\t'$sumLinkBreacksAODV	 >> RREQRREP${11}.dat;
#
#
#
####################################
...
echo "LinkBreacks General: " $sumLinkBreaksD2DRS
echo "LinkBreacksAODV: "$sumLinkBreacksAODV
echo -e "22.5\t"$sumSentRREQD2DRS'\t'$sumRceivedRREPD2DRS'\t'$sumSentRERRD2DRS'\t'$sumLinkBreaksD2DRS'\t'$sumSentRERRAODV'\t'$sumLinkBreacksAODV	 >> RREQRREP${11}.dat;
#
#
#
####################################
