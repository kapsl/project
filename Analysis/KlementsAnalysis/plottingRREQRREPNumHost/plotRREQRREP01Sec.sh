...
set title "Relation RREQ-RREP with Sending Frequency 0.1Sec";
plot "RREQRREP01Sec.dat" using 1:2 title 'RREQTORS' with linespoints ls 1, "RREQRREP01Sec.dat" using 1:3 title 'RRESP' with linespoints ls 2;
